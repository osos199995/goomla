...
@section('content')
      ...
      <div class="x_content">
        <br>
        <form method="POST" action="{{ Route('orders.store') }}" enctype="multipart/form-data" data-parsley-validate="" class="form-horizontal form-label-left" novalidate="">
        ...
        <div class="form-group">
          <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">  الكميه الوحده  <span class="required">*</span>
          </label>
          <div class="col-md-6 col-sm-6 col-xs-12">
            <input  type="number"  name="quantity_unit" id="quantity_unit" value="{{old('quantity_unit')}}" class="form-control col-md-7 col-xs-12" required>
          </div>
        </div>
