      ...
      <div class="x_content">
        ...
        <input name="_method" type="hidden" value="PUT">
            {{ csrf_field() }}
                      ...
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">   الايميل الاول  <span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input  type="text"  name="email1" id="email1" value="{{ $contacts->email1 }}" class="form-control col-md-7 col-xs-12" required>
                        </div>
                      </div>
                  
 
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">   الايميل الثاني  
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input  type="text"  name="email2" id="email2" value="{{ $contacts->email2 }}" class="form-control col-md-7 col-xs-12" required>
                        </div>
                      </div>
