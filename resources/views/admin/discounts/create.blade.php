...
@section('content')
      ...
      <div class="x_content">
        ...
        <div class="form-group">
          <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name"> الخصم   
          </label>
          <div class="col-md-6 col-sm-6 col-xs-12">
        ...
        <div class="form-group">
          <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name"> التاريخ   
          </label>
          <div class="col-md-6 col-sm-6 col-xs-12">
            <input  type="date"  name="date" id="date" value="{{old('date')}}" class="form-control col-md-7 col-xs-12" >
          </div>
        </div>
